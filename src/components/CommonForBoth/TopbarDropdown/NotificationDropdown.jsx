            ...
            <SimpleBar style={{ maxHeight: "230px" }}>
                ...
                <div className="d-flex">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="font-size-12 text-muted">
                      <p className="mb-1">
                        {this.props.t("your order is placed in oure store")}
                      </p>
                      <p className="mb-0">
              ...
              <Link to="#" className="text-reset notification-item">
                <div className="d-flex">
                  ...
                  <div className="flex-1">
                    <h6 className="mt-0 mb-1">
                      {this.props.t("Omar Mohamed")}
                    </h6>
                    <div className="font-size-12 text-muted">
                      <p className="mb-1">
                        {this.props.t("It will be good if order come today.")}
                      </p>
                      <p className="mb-0">
                        <i className="mdi mdi-clock-outline"></i>{" "}
              ...
              <Link to="#" className="text-reset notification-item">
                <div className="d-flex">
                  ...
                  <div className="flex-1">
                    <h6 className="mt-0 mb-1">
                      {this.props.t("Amira Mahmoud")}
                    </h6>
                    <div className="font-size-12 text-muted">
                      <p className="mb-1">
                        {this.props.t("order was successfuly delivered")}
                      </p>
                      <p className="mb-0">
                        <i className="mdi mdi-clock-outline"></i>{" "}
                        {this.props.t("1 hours ago")}
